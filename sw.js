const CACHE='fitness-coach-v9';
const CORE=['/','/index.html','/manifest.webmanifest','/exercise-images-patch.js','/ui-enhancements.js','/food-enhancements.js','/sleep-enhancements.js'];
